...
def build_robust_encoder(image_shape=(256, 256, 3), watermark_shape=(256, 256, 1)):
    ...
    # Unfreeze the last few layers (e.g., last 10 layers)
    for layer in base_model.layers[-10:]:  # Adjust this number as needed
...
# Watermark.
watermark = generate_and_save_watermark()
cv2.imwrite("dataset/watermark_preview.png", (watermark * 255).astype(np.uint8))
print("Watermark saved and preview image generated.")
